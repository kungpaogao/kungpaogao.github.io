...
module.exports = "<nav class=\"navbar navbar-expand-md navbar-light bg-faded fixed-top\">\n\t<button class=\"navbar-toggler navbar-toggler-right\" type=\"button\" (click)=\"toggleState()\">\n\t\t<span class=\"navbar-toggler-icon\"></span>\n\t</button>\n\t<a class=\"navbar-brand\" routerLink=\"home\">BEECOLOGY</a>\n\t<div class=\"collapse navbar-collapse\" [ngClass]=\"{ 'show': navShow }\" id=\"navbarNav\">\n\t\t<ul class=\"navbar-nav ml-auto\">\n\n\t\t\t<li class=\"nav-item\">\n\t\t\t\t<a class=\"nav-link\" routerLink=\"home\" routerLinkActive=\"active\" (click)=\"toggleState()\">HOME</a>\n\t\t\t</li>\n\n\n\t\t\t<li class=\"nav-item\">\n\t\t\t\t<a class=\"nav-link\" routerLink=\"tools\" routerLinkActive=\"active\" (click)=\"toggleState()\">PARTICIPATE</a>\n\t\t\t</li>\n\n\n\t\t\t<li class=\"nav-item\">\n\t\t\t\t<a class=\"nav-link\" routerLink=\"about\" routerLinkActive=\"active\" (click)=\"toggleState()\">ABOUT</a>\n\t\t\t</li>\n\n\t\t\t<li class=\"nav-item\">\n\t\t\t\t<a class=\"nav-link\" routerLink=\"help\" routerLinkActive=\"active\" (click)=\"toggleState()\">HELP</a>\n\t\t\t</li>\n\n\t\t\t<li class=\"nav-item\">\n\t\t\t\t<a class=\"nav-link\" routerLink=\"contact\" routerLinkActive=\"active\" (click)=\"toggleState()\">CONTACT</a>\n\t\t\t</li>\n\n\t\t\t<li class=\"nav-item\">\n\t\t\t\t<a class=\"nav-link link-app\" routerLink=\"app\" routerLinkActive=\"active\" (click)=\"toggleState()\">APP</a>\n\t\t\t</li>\n\n\t\t</ul>\n\t</div>\n</nav>\n\n<router-outlet></router-outlet>"
